...
# a or b might be [] (all languages except R, Shell). a or b might be nil or null or None (except in Haskell, Elixir,
# C++, Rust, R, Shell).
...
def comp(array1,array2):
    if array1 is None or array2 is None:
       return False
    for elemento,numero in zip(sorted(array1),sorted(array2)):
        if elemento != numero**0.5:
            return False
    return True


assert (comp([121, 144, 19, 161, 19, 144, 19, 11],[11*11, 121*121, 144*144, 19*19, 161*161, 19*19, 144*144, 19*19])) == True, "Tiene que devolver True"